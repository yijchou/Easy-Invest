	...
	<form action="getdailydate" method="get">
		...
		<p>
			...
			<div class="form-group">
  				<label class="col-form-label col-form-label-lg mt-4" for="givenDate">Date</label>
  				<input class="form-control form-control-lg" type="text" placeholder="yyyy-MM-dd 00:00:00" id="givenDate" name="givenDate" value="${fn:escapeXml(param.ticker)}">
			</div>
			</center>
		</p>
		<p><center>
